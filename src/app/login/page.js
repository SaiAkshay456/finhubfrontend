...
import { useAuth } from '../../providers/AuthProvider';
import axios from 'axios';
import { Mail, Lock, EyeOff, ChevronDown, Info, Eye } from "lucide-react";
...
export default function LoginForm() {
    ...
    const targetValue = 58668;
    const duration = 2000;
    useEffect(() => {
        if (count === 0) return; // Don't animate on initial render
            ...
            <div className="relative hidden lg:flex flex-col items-center justify-center p-8 gradient-bg">
                ...
                <div className="relative w-full max-w-md p-6 rounded-xl bg-white/30 backdrop-blur-md border border-white/20 z-10">
                    <div className="flex justify-between items-center mb-4">
                        <span className="text-sm text-gray-600 uppercase font-semibold">Markets and PortFolio Trends</span>
            ...
            <div className="flex items-center justify-center p-8 bg-white">
                <div className="w-full max-w-md space-y-6">
                    <div className="flex items-center justify-start mb-8">
                        ...
                        <span className="text-xl font-bold">Go FinTech</span>
                    </div>
