    ...
    useEffect(() => {
        const fetchAllData = async () => {
            ...
            try {
                ...
                const usersRes = await clientAxiosInstance.get(apiURL);
                ...
                if (usersRes.data.success) {
                    ...
                    setStats({
                        ...
                        totalActiveUsers: usersRes.data.totalActiveUsers,
                        totalSuspendedUsers: usersRes.data.totalSuspendedUsers,
