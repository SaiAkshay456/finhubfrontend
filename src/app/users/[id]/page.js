...
//                             </span>
//                             <span className={`px-2 py-0.5 text-xs rounded-full ${user.status.isKycCompleted ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
...
//                             </span>
//                             <span className={`px-2 py-0.5 text-xs rounded-full ${user.status.isKycCompleted ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
//                                 {user.status.onBoardingStatus ? user.riskCategory : 'Risk Profile Pending'}
//                             </span>
//                         </div>
//                     </div>
//                 </div>
...
//                     <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">Client Permissions</h3>
