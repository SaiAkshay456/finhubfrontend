                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p className="text-gray-600 text-sm mt-1">
                                Manage your risk profile questionnaires
                            </p>
                        </div>
                        <LinkComponent
                            link="/riskprofile/create-questionarre"
                ...
                {questionnaires.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
                        {questionnaires.map((q) => (
                            <div
                                key={q._id}
                                className="bg-white rounded-md shadow-sm hover:shadow-md transition-all duration-200 border border-gray-100 overflow-hidden flex flex-col"
                            >
                                {/* Card Header */}
                                <div className="p-3 sm:p-4 flex-1">
                                    <div className="mb-2 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div
                                            className={`px-2 py-0.5 rounded-full text-xs font-medium ${q.isPublished
                                                ? 'bg-green-100 text-green-800'
                                                : 'bg-yellow-100 text-yellow-800'
                                                }`}
                                        >
