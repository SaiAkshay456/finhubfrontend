...
import LinkComponent from "../../components/LinkComponent";
import Link from "next/link";
import DupliacateQuestionarreButton from "../../components/DupliacateQuestionarreButton";// Assuming this is your client-side axios instance
import { API_BASE, RISK_ROUTES } from "@/helpers/apiRoutes";
import { IoTrashOutline } from "react-icons/io5";
...
export default function RiskPage() {
    ...
    useEffect(() => {
        const fetchQuestionnaires = async () => {
            setLoading(true);
            try {
                const { data } = await clientAxiosInstance.get(`${API_BASE}/${RISK_ROUTES.GET_QUESTIONNARIES}`);
                if (data.success) {
    ...
    // Placeholder for a handleDelete function
    const handleDelete = (id) => {
        // Implement your client-side delete logic here
