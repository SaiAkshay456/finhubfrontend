...
//                 responses,
//                 tokenId
//                 // this should look like { questionId: optionId }
//             }, {
...
//                     <div
//                         key={question._id}
//                         className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:border-blue-100 transition-all duration-200"
//                     >
//                         <div className="flex items-start space-x-3">
//                             <span className="flex-shrink-0 mt-1 w-6 h-6 rounded-full bg-blue-100 text-blue-800 font-medium flex items-center justify-center text-sm">
//                                 {qIndex + 1}
//                             </span>
...
//                                         <label
//                                             key={oIndex}
//                                             className={`flex items-center space-x-3 cursor-pointer px-4 py-3 rounded-lg border transition-all duration-200 ${responses[question._id] === opt.label
...
//                     className={`inline-flex items-center justify-center min-w-[200px] bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-medium px-8 py-3 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg ${isSubmitting ? 'opacity-80 cursor-not-allowed' : ''
//                         }`}
//                 >
//                     {isSubmitting ? (
//                         <>
...
//                     <h2 className="text-xl font-semibold text-gray-800">Risk Assessment Questionnaire</h2>
//                     <p className="text-sm text-gray-500 mt-1">Please answer all questions carefully</p>
//                 </div>

//                 <form onSubmit={handleSubmit} className="divide-y divide-gray-100">
//                     {msg && (
//                         <div className={`p-4 ${msg.toLowerCase().includes('success') ? 'bg-green-50' : 'bg-red-50'}`}>
//                             <div className={`flex items-center text-sm ${msg.toLowerCase().includes('success') ? 'text-green-700' : 'text-red-700'}`}>
...
//                                 <legend className="text-base font-medium text-gray-700 flex items-center">
//                                     <span className="mr-2 flex items-center justify-center w-6 h-6 bg-blue-100 text-blue-800 rounded-full text-sm">
//                                         {qIndex + 1}
//                                     </span>
//                                     {question.text}
//                                 </legend>
...
//                             type="submit"
//                             disabled={isSubmitting}
//                             className={`inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 min-w-[180px] ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
//                         >
//                             {isSubmitting ? (
//                                 <>
