...
export default function CreateRecommendationModal({
        ...
        const fetchInitialAssets = async () => {
            try {
                const res = await fetch(
                    'http://localhost:3030/v1/mutualfund/list-mf?page=1&limit=50'
                )
    ...
    useEffect(() => {
        ...
        const fetchAssets = async () => {
            try {
                const res = await fetch(
                    `http://localhost:3030/v1/mutualfund/list-mf?page=${page}&limit=50&search=${searchTerm}`,
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await fetch(
                'http://localhost:3030/api/v1/recommendations/create',
                {
                    method: 'POST',
                ...
                <div className="sticky top-0 bg-white rounded-t-2xl border-b border-gray-100 px-8 py-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Add a new investment recommendation
                        </p>
                    </div>
                    <button
                        onClick={onClose}
