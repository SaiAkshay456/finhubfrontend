                    ...
                    <div className="flex justify-center">
                        <div className="flex items-center space-x-8">
                            <div className="flex items-center">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold border-2 ${step >= 1 ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-400 border-gray-300'
                                    }`}>
                                    {step > 1 ? '✓' : '1'}
                                </div>
                                <span className={`ml-3 text-sm font-medium ${step >= 1 ? 'text-blue-600' : 'text-gray-400'}`}>
                                    Personal Information
                                </span>
                            </div>
                            <div className={`w-16 h-px ${step >= 2 ? 'bg-blue-600' : 'bg-gray-300'}`}></div>
                            <div className="flex items-center">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold border-2 ${step >= 2 ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-400 border-gray-300'
                                    }`}>
                                    {step > 2 ? '✓' : '2'}
                                </div>
                                <span className={`ml-3 text-sm font-medium ${step >= 2 ? 'text-blue-600' : 'text-gray-400'}`}>
                                    Access Permissions
                                </span>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="flex justify-end pt-8 mt-8 border-t border-gray-200">
                                    <button
                                        type="button"
                                        onClick={nextStep}
                                        className="px-8 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors text-sm font-medium"
                                    >
                                        Continue
                                    </button>
                                </div>
                            ...
                            <div>
                                ...
                                <div className="flex justify-between pt-8 mt-8 border-t border-gray-200">
                                    ...
                                    <button
                                        ...
                                        className="px-8 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors text-sm font-medium"
                                    >
                                        Create User
                                    </button>
                                </div>
