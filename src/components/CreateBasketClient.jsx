...
//                     <h2 className="text-3xl font-bold text-gray-900">Create Investment Basket</h2>
...
//                                 className={`w-full px-6 py-3 rounded-lg font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 transition ${isSubmitting
